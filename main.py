...
# CONFIG
VERSION = "1.21.1"
FAST_DOWNLOAD = False  # DOES NOT INSTALL ASSETS (USE FOR DEBUG)
...
def get_version_json_url(version_id, text_box):
    ...
    try:
        ...
        log(f"Error fetching version URL: {e}", text_box)
...
def download_assets(index_url, asset_index_id, text_box):
    ...
    try:
        ...
        log(f"Error downloading assets: {e}", text_box)
...
# my personal fuck you to noface
